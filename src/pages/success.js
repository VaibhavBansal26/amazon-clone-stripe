        ...
        <div className="bg-gray-100 h-screen">
            ...
            <main className="max-w-screen-lg mx-auto">
                <div className="flex flex-col p-10 bg-white ">
                    <div className="flex items-center space-x-2 mb-5 mt-20">
                        <CheckCircleIcon className="text-green-500 h-14"/>
                        <h1 className="text-3xl"> Thank you, Your order has been confirmed!</h1>
                    </div>
                    <p>
                        Thank you for shopping with us. We'll send a confirmation once your item has shipped ,if you would linke to check the 
